...
dependencies {
	...
	include(project(":module:broadcast:client:1.0.0-alpha.1.0.6-to-1.3.0-alpha.12w16a"))
	...
	include(project(":module:identity:server:1.0.0-alpha.0.1.0-to-1.0.0-beta.1.4.0"))
	include(project(":module:identity:server:1.0.0-beta.1.5.0-to-1.3.0-alpha.12w17a"))
	...
	include(project(":module:statistic:combat:client:0.31.20100327-to-0.31.20100330-1611"))
	include(project(":module:statistic:combat:client:0.31.20100413-to-1.0.0-alpha.1.0.16"))
	include(project(":module:statistic:combat:client:1.0.0-alpha.1.0.17-to-1.0.0-beta.1.4.0"))
	include(project(":module:statistic:combat:merged:1.0.0-beta.1.5.0-to-1.1.0-beta.1.7.3"))
	include(project(":module:statistic:combat:merged:1.0.0-beta.1.8.0-pre.1-to-1.1.0-alpha.11w48a"))
	include(project(":module:statistic:combat:merged:1.1.0-alpha.11w49a-to-1.1.0-alpha.11w50a"))
	include(project(":module:statistic:combat:merged:1.1.0-alpha.12w01a-to-1.6.4"))
	include(project(":module:statistic:combat:server:1.0.0-alpha.0.1.0-to-1.0.0-alpha.0.1.3"))
	include(project(":module:statistic:combat:server:1.0.0-alpha.0.1.4-to-1.0.0-beta.1.4.0"))

	include(project(":module:statistic:item-transfer:merged:0.31.20100327-to-1.2.0-alpha.12w08a"))
	include(project(":module:statistic:item-transfer:merged:1.2.0-to-1.6.4"))
	include(project(":module:statistic:item-transfer:merged:1.7.0-alpha.13w36a-to-1.7.0-alpha.13w37b"))
	include(project(":module:statistic:item-transfer:merged:1.7.0-alpha.13w38a-to-1.8.0-alpha.14w05b"))
	include(project(":module:statistic:item-transfer:merged:1.8.0-alpha.14w06a-to-1.8.0-alpha.14w08a"))
	include(project(":module:statistic:item-transfer:merged:1.8.0-alpha.14w10a-to-1.8.0-alpha.14w26c"))
	include(project(":module:statistic:item-transfer:merged:1.8.0-alpha.14w27a-to-1.8.0-alpha.14w28b"))
	// NOTE: Maybe split on 1.8.2-pre.4 / 1.8.2-pre.5
	// IdRegistry changes here to actually be generic, and not return Object
	include(project(":module:statistic:item-transfer:merged:1.8.0-alpha.14w29a-to-1.9.0-alpha.15w32c"))
	include(project(":module:statistic:item-transfer:merged:1.9.0-alpha.15w33a-to-1.12.0-alpha.17w06a"))
	include(project(":module:statistic:item-transfer:merged:1.12.0-alpha.17w13a-to-1.12.2"))
	include(project(":module:statistic:item-transfer:server:1.0.0-alpha.0.1.0-to-1.0.0-alpha.0.2.8"))
	...
	include(project(":module:statistic:sheep-shearing:0.31.20100327-to-1.0.0-beta.1.6.6"))
	include(project(":module:statistic:sheep-shearing:1.0.0-beta.1.7.0-to-1.5.2"))
	include(project(":module:statistic:sheep-shearing:1.6.0-alpha.13w16a-to-1.8.9"))
	include(project(":module:statistic:sheep-shearing:1.9.0-alpha.15w31a-to-1.12.2"))

	include(project(":module:statistic:vanilla:client:0.31.20100327-to-0.31.20100330"))
	include(project(":module:statistic:vanilla:client:0.31.20100413-to-0.31.20100420"))
	include(project(":module:statistic:vanilla:client:0.31.20100607-to-0.31.20100611"))
	include(project(":module:statistic:vanilla:client:0.31.20100615-to-0.31.20100618"))
	include(project(":module:statistic:vanilla:client:0.31.20100624-to-0.31.20100625-0922"))
	include(project(":module:statistic:vanilla:client:0.31.20100625-1917-to-0.31.20100625-1917"))
	include(project(":module:statistic:vanilla:client:0.31.20100627-to-0.31.20100629"))
	include(project(":module:statistic:vanilla:client:0.31.20100630-to-1.0.0-alpha.1.0.4"))
	include(project(":module:statistic:vanilla:client:1.0.0-alpha.1.0.5.0-to-1.0.0-alpha.1.0.5.0"))
	include(project(":module:statistic:vanilla:client:1.0.0-alpha.1.0.5.1-to-1.0.0-alpha.1.0.5.1"))
	include(project(":module:statistic:vanilla:client:1.0.0-alpha.1.0.6-to-1.0.0-alpha.1.0.7"))
	include(project(":module:statistic:vanilla:client:1.0.0-alpha.1.0.8-to-1.0.0-alpha.1.0.14"))
	include(project(":module:statistic:vanilla:client:1.0.0-alpha.1.0.15-to-1.0.0-alpha.1.1.2"))
	include(project(":module:statistic:vanilla:client:1.0.0-alpha.1.2.0-to-1.0.0-alpha.1.2.1"))
	include(project(":module:statistic:vanilla:client:1.0.0-alpha.1.2.2-to-1.0.0-alpha.1.2.6"))
	...
	include(project(":module:statistic:vanilla:common:0.31.20100630-to-1.0.0-alpha.1.2.6"))
	include(project(":module:statistic:vanilla:common:1.0.0-beta.1.0.0-to-1.0.0-beta.1.3.0"))
	...
	include(project(":module:statistic:vanilla:server:1.0.0-alpha.0.1.0-to-1.0.0-alpha.0.2.3"))
	include(project(":module:statistic:vanilla:server:1.0.0-alpha.0.2.4-to-1.0.0-alpha.0.2.4"))
	include(project(":module:statistic:vanilla:server:1.0.0-alpha.0.2.5-to-1.0.0-alpha.0.2.6"))
	include(project(":module:statistic:vanilla:server:1.0.0-alpha.0.2.7-to-1.0.0-alpha.0.2.8"))
