...
public class Achievements {
	...
	public static final ServerAchievement CRAFT_CAKE = registerConditionally("bakeCake", "1.0.0-beta.2", "1.0.0-beta.2", CRAFT_WOODEN_HOE);
	...
	public static final ServerAchievement COOK_FISH = registerConditionally("cookFish", "1.0.0-alpha.2.0", "1.0.0-alpha.2.4", CRAFT_FURNACE);
	public static final ServerAchievement TRAVEL_KILOMETER_BY_MINECART = registerConditionally("onARail", "0.31.20100624", "0.31.20100624", GET_IRON_INGOT);
	...
	public static final ServerAchievement RIDE_PIG_OFF_CLIFF = registerConditionally("flyPig", "0.31.20100625-1917", "0.31.20100625-1917", KILL_COW);

	public static void init() {}

	private static @Nullable ServerAchievement registerConditionally(String identifier, String clientStartVersion, String serverStartVersion, ServerAchievement parent) {
		Version want;
