...
include(":module:statistic:vanilla:client:1.0.0-alpha.1.0.1-to-1.0.0-alpha.1.0.4")
...
include(":module:statistic:vanilla:common:1.0.0-alpha.1.0.1-to-1.0.0-alpha.1.2.6")
